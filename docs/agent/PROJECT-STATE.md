...
- **ACBP-P7-013 HTTP rate limiting — BUILT AND WIRED, NOT OWNER-ACCEPTED** (CDR-081; NFR-010; CDR-008 §8;
  ...
  - **RAISED BY ACBP-P7-007** (CDR-080 §4), which ruled NFR-010's absent ASVS items into separate tickets rather
    ...
    rows and the same plan line — whichever merges second resolves that conflict. Recorded in CDR-081 §7.
  ...
  - **SCOPE ESTABLISHED, NOT ASSUMED.** (a) Clerk covers the auth surface and ONLY it — sign-in/sign-up are
    ...
    recorded as a constraint (CDR-081 §1.4) rather than proposed. (c) State is PostgreSQL, because a per-process
  ...
  - **NOT CLOSED, and none of these is an engineering gap I may close alone:** CSRF protection and security
    headers/CSP (NFR-010's other two items — CDR-081 §8.2/§8.3); the pen review (external vendor, General MVP
