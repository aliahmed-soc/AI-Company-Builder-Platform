 ...
 * own phrasing — `WORKFLOW-STATE-MACHINES.md:81` (the `queued→running` row) states the precondition as
 * *"stop-state clear; company active"*, and `diagrams/06:10` writes the same thing with a `+` — and it is not a
 * style preference. It buys three properties a denylist cannot:
 *
