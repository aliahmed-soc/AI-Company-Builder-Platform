...
describe.skipIf(!hasTestDatabase)('rollup reconciliation (real PostgreSQL) — ACBP-P6-009/CDR-073, launch gate 7', () => {
  ...
  beforeEach(async () => {
    for (const t of ['usage_corrections', 'api_rate_limit_buckets', 'account_usage_rollups', 'usage_events', 'audit_events', 'company_memberships', 'company_profiles', 'companies', 'memberships', 'accounts', 'users'] as const) {
